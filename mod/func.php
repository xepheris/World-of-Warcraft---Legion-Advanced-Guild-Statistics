...
function import($char) {
	...
	$jaedenar = array('Innos', 'Aya', 'Altra', 'Gnomonk');
	$dunemaul = array('Naija', 'Ironblood', 'Stormbrew', 'Birdofwar', 'Wrewdink', 'Carnels');
	
	if(in_array($char, $jaedenar)) {
		$server = 'Jaedenar';
	}
	if(in_array($char, $dunemaul)) {
		$server = 'Dunemaul';
	}
		...
		if($data != '') {
			...
			if($data['guild']['name'] == $_SESSION['g']) {
				...
				if($data['level'] == '110') {
					...
					$table = mysqli_query($stream, "CREATE TABLE IF NOT EXISTS `" .$_SESSION['t']. "` (`id` int(4) NOT NULL AUTO_INCREMENT, `ch` varchar(16) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL, `llog` int(10) NOT NULL, `lupd` int(10) NOT NULL, `c` tinyint(1) NOT NULL, `s` text COLLATE latin1_german2_ci NOT NULL, `he_id` mediumint(6) NOT NULL, `he_ilvl` smallint(4) NOT NULL, `he_g` mediumint(6) NOT NULL, `he_e` mediumint(6) NOT NULL, `he_b` varchar(20) COLLATE latin1_german2_ci NOT NULL, `n_id` mediumint(6) NOT NULL, `n_ilvl` smallint(4) NOT NULL, `n_g` mediumint(6) NOT NULL, `n_e` mediumint(6) NOT NULL, `n_b` varchar(20) COLLATE latin1_german2_ci NOT NULL, `s_id` mediumint(6) NOT NULL, `s_ilvl` smallint(4) NOT NULL, `s_g` mediumint(6) NOT NULL, `s_e` mediumint(6) NOT NULL, `s_b` varchar(20) COLLATE latin1_german2_ci NOT NULL, `b_id` mediumint(6) NOT NULL, `b_ilvl` smallint(4) NOT NULL, `b_g` mediumint(6) NOT NULL, `b_e` mediumint(6) NOT NULL, `b_b` varchar(20) COLLATE latin1_german2_ci NOT NULL, `c_id` mediumint(6) NOT NULL, `c_ilvl` smallint(4) NOT NULL, `c_g` mediumint(6) NOT NULL, `c_e` mediumint(6) NOT NULL, `c_b` varchar(20) COLLATE latin1_german2_ci NOT NULL, `wr_id` mediumint(6) NOT NULL, `wr_ilvl` smallint(4) NOT NULL, `wr_g` mediumint(6) NOT NULL, `wr_e` mediumint(6) NOT NULL, `wr_b` varchar(20) COLLATE latin1_german2_ci NOT NULL, `ha_id` mediumint(6) NOT NULL, `ha_ilvl` smallint(4) NOT NULL, `ha_g` mediumint(6) NOT NULL, `ha_e` mediumint(6) NOT NULL, `ha_b` varchar(20) COLLATE latin1_german2_ci NOT NULL, `wa_id` mediumint(6) NOT NULL, `wa_ilvl` smallint(4) NOT NULL, `wa_g` mediumint(6) NOT NULL, `wa_e` mediumint(6) NOT NULL, `wa_b` varchar(20) COLLATE latin1_german2_ci NOT NULL, `l_id` mediumint(6) NOT NULL, `l_ilvl` smallint(4) NOT NULL, `l_g` mediumint(6) NOT NULL, `l_e` mediumint(6) NOT NULL, `l_b` varchar(20) COLLATE latin1_german2_ci NOT NULL, `f_id` mediumint(6) NOT NULL, `f_ilvl` smallint(4) NOT NULL, `f_g` mediumint(6) NOT NULL, `f_e` mediumint(6) NOT NULL, `f_b` varchar(20) COLLATE latin1_german2_ci NOT NULL, `f1_id` mediumint(6) NOT NULL, `f1_ilvl` smallint(4) NOT NULL, `f1_g` mediumint(6) NOT NULL, `f1_e` mediumint(6) NOT NULL, `f1_b` varchar(20) COLLATE latin1_german2_ci NOT NULL, `f2_id` mediumint(6) NOT NULL, `f2_ilvl` smallint(4) NOT NULL, `f2_g` mediumint(6) NOT NULL, `f2_e` mediumint(6) NOT NULL, `f2_b` varchar(20) COLLATE latin1_german2_ci NOT NULL, `t1_id` mediumint(6) NOT NULL, `t1_ilvl` smallint(4) NOT NULL, `t1_g` mediumint(6) NOT NULL, `t1_e` mediumint(6) NOT NULL, `t1_b` varchar(20) COLLATE latin1_german2_ci NOT NULL, `t2_id` mediumint(6) NOT NULL, `t2_ilvl` smallint(4) NOT NULL, `t2_g` mediumint(6) NOT NULL, `t2_e` mediumint(6) NOT NULL, `t2_b` varchar(20) COLLATE latin1_german2_ci NOT NULL, `mh_ilvl` smallint(4) NOT NULL, `mh_b` varchar(20) COLLATE latin1_german2_ci NOT NULL, `mh_r1` mediumint(6) NOT NULL, `mh_r1b` varchar(20) COLLATE latin1_german2_ci NOT NULL, `mh_r2` mediumint(6) NOT NULL, `mh_r2b` varchar(20) COLLATE latin1_german2_ci NOT NULL, `mh_r3` mediumint(6) NOT NULL, `mh_r3b` varchar(20) COLLATE latin1_german2_ci NOT NULL, `oh_ilvl` smallint(4) NOT NULL, `oh_bonus` varchar(20) COLLATE latin1_german2_ci NOT NULL, `oh_r1` mediumint(6) NOT NULL, `oh_r1b` varchar(20) COLLATE latin1_german2_ci NOT NULL, `oh_r2` mediumint(6) NOT NULL, `oh_r2b` varchar(20) COLLATE latin1_german2_ci NOT NULL, `oh_r3` mediumint(6) NOT NULL, `oh_r3b` varchar(20) COLLATE latin1_german2_ci NOT NULL, `ilvlavg` smallint(4) NOT NULL, `ilvlbags` smallint(4) NOT NULL, `eoa` int(5) NOT NULL, `dht` int(5) NOT NULL, `nel` int(5) NOT NULL, `hov` int(5) NOT NULL, `vh` int(5) NOT NULL, `vow` int(5) NOT NULL, `brh` int(5) NOT NULL, `mos` int(5) NOT NULL, `arc` int(5) NOT NULL, `cos` int(5) NOT NULL, `sum` int(5) NOT NULL, `en` tinyint(1) NOT NULL, `tov` tinyint(1) NOT NULL, `nh` tinyint(1) NOT NULL, `alvl` smallint(3) NOT NULL, `ap` int(11) NOT NULL, `ak` tinyint(3) NOT NULL, PRIMARY KEY (`id`), UNIQUE KEY `id` (`id`), KEY `id_2` (`id`)) ENGINE=MyISAM  DEFAULT CHARSET=latin1 COLLATE=latin1_german2_ci AUTO_INCREMENT=2 ;");
					if(!$table) {
						echo '<p id="error">Sorry, could not generate database entry at this time. Please retry!</p>';
					}
					
					// CREATE ARCHIVE TABLE
					$archive = mysqli_query($stream, "CREATE TABLE IF NOT EXISTS `" .$_SESSION['t']. "_archive` (`id` int(4) NOT NULL AUTO_INCREMENT, `ch` varchar(16) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL, `llog` int(10) NOT NULL, `lupd` int(10) NOT NULL, `c` tinyint(1) NOT NULL, `s` text COLLATE latin1_german2_ci NOT NULL, `he_id` mediumint(6) NOT NULL, `he_ilvl` smallint(4) NOT NULL, `he_g` mediumint(6) NOT NULL, `he_e` mediumint(6) NOT NULL, `he_b` varchar(20) COLLATE latin1_german2_ci NOT NULL, `n_id` mediumint(6) NOT NULL, `n_ilvl` smallint(4) NOT NULL, `n_g` mediumint(6) NOT NULL, `n_e` mediumint(6) NOT NULL, `n_b` varchar(20) COLLATE latin1_german2_ci NOT NULL, `s_id` mediumint(6) NOT NULL, `s_ilvl` smallint(4) NOT NULL, `s_g` mediumint(6) NOT NULL, `s_e` mediumint(6) NOT NULL, `s_b` varchar(20) COLLATE latin1_german2_ci NOT NULL, `b_id` mediumint(6) NOT NULL, `b_ilvl` smallint(4) NOT NULL, `b_g` mediumint(6) NOT NULL, `b_e` mediumint(6) NOT NULL, `b_b` varchar(20) COLLATE latin1_german2_ci NOT NULL, `c_id` mediumint(6) NOT NULL, `c_ilvl` smallint(4) NOT NULL, `c_g` mediumint(6) NOT NULL, `c_e` mediumint(6) NOT NULL, `c_b` varchar(20) COLLATE latin1_german2_ci NOT NULL, `wr_id` mediumint(6) NOT NULL, `wr_ilvl` smallint(4) NOT NULL, `wr_g` mediumint(6) NOT NULL, `wr_e` mediumint(6) NOT NULL, `wr_b` varchar(20) COLLATE latin1_german2_ci NOT NULL, `ha_id` mediumint(6) NOT NULL, `ha_ilvl` smallint(4) NOT NULL, `ha_g` mediumint(6) NOT NULL, `ha_e` mediumint(6) NOT NULL, `ha_b` varchar(20) COLLATE latin1_german2_ci NOT NULL, `wa_id` mediumint(6) NOT NULL, `wa_ilvl` smallint(4) NOT NULL, `wa_g` mediumint(6) NOT NULL, `wa_e` mediumint(6) NOT NULL, `wa_b` varchar(20) COLLATE latin1_german2_ci NOT NULL, `l_id` mediumint(6) NOT NULL, `l_ilvl` smallint(4) NOT NULL, `l_g` mediumint(6) NOT NULL, `l_e` mediumint(6) NOT NULL, `l_b` varchar(20) COLLATE latin1_german2_ci NOT NULL, `f_id` mediumint(6) NOT NULL, `f_ilvl` smallint(4) NOT NULL, `f_g` mediumint(6) NOT NULL, `f_e` mediumint(6) NOT NULL, `f_b` varchar(20) COLLATE latin1_german2_ci NOT NULL, `f1_id` mediumint(6) NOT NULL, `f1_ilvl` smallint(4) NOT NULL, `f1_g` mediumint(6) NOT NULL, `f1_e` mediumint(6) NOT NULL, `f1_b` varchar(20) COLLATE latin1_german2_ci NOT NULL, `f2_id` mediumint(6) NOT NULL, `f2_ilvl` smallint(4) NOT NULL, `f2_g` mediumint(6) NOT NULL, `f2_e` mediumint(6) NOT NULL, `f2_b` varchar(20) COLLATE latin1_german2_ci NOT NULL, `t1_id` mediumint(6) NOT NULL, `t1_ilvl` smallint(4) NOT NULL, `t1_g` mediumint(6) NOT NULL, `t1_e` mediumint(6) NOT NULL, `t1_b` varchar(20) COLLATE latin1_german2_ci NOT NULL, `t2_id` mediumint(6) NOT NULL, `t2_ilvl` smallint(4) NOT NULL, `t2_g` mediumint(6) NOT NULL, `t2_e` mediumint(6) NOT NULL, `t2_b` varchar(20) COLLATE latin1_german2_ci NOT NULL, `mh_ilvl` smallint(4) NOT NULL, `mh_b` varchar(20) COLLATE latin1_german2_ci NOT NULL, `mh_r1` mediumint(6) NOT NULL, `mh_r1b` varchar(20) COLLATE latin1_german2_ci NOT NULL, `mh_r2` mediumint(6) NOT NULL, `mh_r2b` varchar(20) COLLATE latin1_german2_ci NOT NULL, `mh_r3` mediumint(6) NOT NULL, `mh_r3b` varchar(20) COLLATE latin1_german2_ci NOT NULL, `oh_ilvl` smallint(4) NOT NULL, `oh_bonus` varchar(20) COLLATE latin1_german2_ci NOT NULL, `oh_r1` mediumint(6) NOT NULL, `oh_r1b` varchar(20) COLLATE latin1_german2_ci NOT NULL, `oh_r2` mediumint(6) NOT NULL, `oh_r2b` varchar(20) COLLATE latin1_german2_ci NOT NULL, `oh_r3` mediumint(6) NOT NULL, `oh_r3b` varchar(20) COLLATE latin1_german2_ci NOT NULL, `ilvlavg` smallint(4) NOT NULL, `ilvlbags` smallint(4) NOT NULL, `eoa` int(5) NOT NULL, `dht` int(5) NOT NULL, `nel` int(5) NOT NULL, `hov` int(5) NOT NULL, `vh` int(5) NOT NULL, `vow` int(5) NOT NULL, `brh` int(5) NOT NULL, `mos` int(5) NOT NULL, `arc` int(5) NOT NULL, `cos` int(5) NOT NULL, `sum` int(5) NOT NULL, `en` tinyint(1) NOT NULL, `tov` tinyint(1) NOT NULL, `nh` tinyint(1) NOT NULL, `alvl` smallint(3) NOT NULL, `ap` int(11) NOT NULL,  `ak` tinyint(3) NOT NULL, PRIMARY KEY (`id`), UNIQUE KEY `id` (`id`), KEY `id_2` (`id`)) ENGINE=MyISAM  DEFAULT CHARSET=latin1 COLLATE=latin1_german2_ci AUTO_INCREMENT=2 ;");
					if(!$archive) {
						echo '<p id="error">Sorry, could not generate database entry at this time. Please retry!</p>';
					}
